...
const { switchTheme } = systemStore()

const active = ref<boolean>(false)

const darkOrHighThemeOn = (value: boolean) => {
    switchTheme(!value)
}
</script>
...
<template>
    <div class="navigation">
        <n-gradient-text type="info">Docker-Registry-UI</n-gradient-text>
        <n-switch v-model:value="active" @update:value="darkOrHighThemeOn">
